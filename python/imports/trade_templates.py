...
def enrichment(positionId, initialVol, initialR, initialQ, initialMargin, initialPricingValue,
               initialStdDelta, initialDelta, initialDeltaCash, initialGamma, initialGammaCash, initialVega,
               initialTheta, initialRhoR, initialStdGamma, initialUnderlyerPrice, trader, initialPnl):
    enrichment = {
        "positionId": "0001-01_0",
        "initialVol": 0.22,
        "initialR": 0.33,
        "initialQ": 0.44,
        "initialMargin": 11,
        "initialPricingValue": 66,
        "initialStdDelta": 0.77,
        "initialDelta": 88,
        "initialDeltaCash": 99,
        "initialGamma": 110,
        "initialGammaCash": 120,
        "initialVega": 130,
        "initialTheta": 140,
        "initialRhoR": "150",
        "initialStdGamma": 10,
        "initialUnderlyerPrice": 55,
        "trader": "admin",
        "initialPnl": 19175.463276
    }
    return enrichment
...
def vanilla_european_position(option_type, strike_type, strike,
                     direction, underlyer, multiplier, specified_price, init_spot, expiration_date,
                     notional_amount_type, notional, participation_rate, annualized, term, days_in_year,
    ...
    return position(asset, 'VANILLA_EUROPEAN', counter_party)

def vanilla_european_trade(positions,trade_id, book, trade_date, trader, sales):
